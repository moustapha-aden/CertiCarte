...
<head>
    ...
    <title>Modifier l'Étudiant - {{ $student->name }} - Lycée de Balbala</title>
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 font-medium">Modification d'Étudiant</p>
                    </div>
                </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            ...
            <div class="mb-8 border-b pb-4">
                <h1 class="text-2xl font-bold text-gray-800 flex items-center space-x-3">
                    ...
                    <span>Modifier l'Étudiant : {{ $student->name }}</span>
                </h1>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender"
                                ...
                                <option value="male"
                                    {{ old('gender', $student->gender) == 'male' ? 'selected' : '' }}>Masculin</option>
                                <option value="female"
                                    {{ old('gender', $student->gender) == 'female' ? 'selected' : '' }}>Féminin
                                </option>
                            </select>
                            @error('gender')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <select id="class_id" name="class_id"
                                ...
                                @if (isset($classes) && is_iterable($classes))
                                    @foreach ($classes as $id => $label)
                                        <option value="{{ $id }}"
                                            {{ old('class_id', $student->class_id) == $id ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                @else
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Formats acceptés : JPG, PNG, GIF. Taille max : 2MB</p>
                            <div class="mt-2">
                                <p class="text-sm text-gray-600">Photo actuelle :</p>
                                <img src="{{ $student->avatar_url }}" alt="{{ $student->name }}" class="w-16 h-16 rounded-lg object-cover mt-1 border border-gray-200">
                            </div>
                            @error('photo')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
