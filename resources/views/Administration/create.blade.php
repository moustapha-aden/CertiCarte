...
<head>
    ...
    <title>Créer un utilisateur - Lycée de Balbala</title>
...
<body class="bg-gray-50 min-h-screen">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 font-medium">Créer un utilisateur</p>
                    </div>
                </div>
    ...
    <main class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100">
            <h2 class="text-3xl font-extrabold mb-6 text-gray-900">Créer un utilisateur</h2>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('users.index') }}" class="text-blue-500 hover:underline font-semibold">Retour à la liste des utilisateurs</a>
            </div>
        </div>
    </main>
