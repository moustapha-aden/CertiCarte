            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-input 
                        ...
                        :options="$schoolYears" 
                        :value="old('year_id', $classe->year_id)" 
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $classe->students_count ?? $classe->students->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900">{{ $classe->created_at->format('d/m/Y') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
