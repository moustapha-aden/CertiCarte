        ...
        <div class="max-w-6xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div class="mb-6 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-indigo-600">{{ $classes->count() }} classe(s) •
                                {{ $totalStudents }} élève(s)</p>
                        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @forelse ($classes as $classe)
                    ...
                    <div
                        class="p-6 bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
                        ...
                        <div class="space-y-2 mb-4">
                            <p class="text-sm font-medium text-gray-500">
                                Total Élèves: <span
                                    class="font-bold text-gray-900">{{ $classe->students->count() }}</span>
                            </p>
