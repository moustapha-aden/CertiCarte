...
@section('content')
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-4 flex-1">
                    ...
                    <div class="relative flex-1 max-w-md">
                        <input type="search" name="search" id="students_search" placeholder="Rechercher (nom ou matricule)..."
                            ...
                            class="w-full px-3 py-2 pl-10 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-gray-400"
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select name="per_page" id="students_per_page"
                                    ...
                                    @if (count($report['not_found']) > 20)
                                        <div class="relative mb-3">
                                            <input type="text" id="searchNotFoundPhotos"
                                                ...
                                                class="w-full px-3 py-2 pl-10 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 placeholder:text-gray-400">
    ...
    (function() {
        ...
        var perPageSelect = document.getElementById('students_per_page');
